 ...
 *
 */
public class CProducerToWMStest implements Serializable{
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(CProducerToWMStest.USERNAME, CProducerToWMStest.PASSWORD, CProducerToWMStest.BROKEURL);
        try {
            //通过连接工厂获取连接
            ...
            //发送消息
            sendMessage(session, messageProducerToWMS);
