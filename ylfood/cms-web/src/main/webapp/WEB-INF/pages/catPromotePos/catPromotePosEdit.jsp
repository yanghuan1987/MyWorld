...
<body ng-app="catPromotePosEditApp" ng-cloak ng-controller="catPromotePosEditctrl">

		<input type="hidden" value="${id}" name="catPromotePosid" id="catPromotePosid"/>
			...
			<div id="content" class="sp-content">
				...
				<table>
					<tr>
						...
						<td>
						<img id="catPicture" style="width: 50px; height: 50px;"
						ng-src="{{catPromotePoslist.imageUrl}}" /></td>
                        ...
                        <td><input type="text" class="sp-input sp-input-md" maxlength="3" ng-model="catPromotePoslist.displayOrder" ng-pattern="/^[1-9]\d*$/" required></td>
					</tr>
				</table>
				<br>
				<div>
				...
				<div style="text-align: center;">
					<input type="button" class="sp-btn sp-btn-gray-md" value="保存"
						ng-click="mainSavedate()"> <input type="button"
