...
%>
<div style="width: 100%;" id="threeCategory"
		...
		<div class="sp-panel">
			<div class="sp-panel-body">
				...
				<div class="row sp-div-none">
					...
					<br>
					<div ng-if="buttonType == 1">
						<button type="button" ng-show="!notEditAble"
							class="sp-btn sp-btn-gray-md"
							style="margin-left: 37%;" ng-click="submitCategoryThreeForm()" ng-disabled="notEditAbleThree">完成</button>
						<button type="button" ng-show="!notEditAble"
							class="sp-btn sp-btn-gray-md" ng-click="returnCategoryForm(3)">返回</button>
					</div>
					
					<div ng-if="buttonType == 0">
						<button type="button" ng-show="!notEditAble"
							class="sp-btn sp-btn-gray-md"
