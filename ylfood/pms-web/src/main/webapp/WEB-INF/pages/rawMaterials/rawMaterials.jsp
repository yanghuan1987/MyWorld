...
<body ng-app="rawMaterialsApp" style="overflow: hidden;" ng-controller="rawMaterialsController" ng-cloak class="ng-cloak">
<input type="text" id="server" value="<%=path%>" style="display: none;"/>
	<jsp:include page="../common/rawMaterialsHead.jsp"></jsp:include>

	<!-- main container -->
	<div class="row">
		<jsp:include page="/WEB-INF/pages/common/menu.jsp"></jsp:include>
		<jsp:include page="rawMaterialsMenu.jsp"></jsp:include>
		<jsp:include page="rawMaterialsTable.jsp"></jsp:include>
		<jsp:include page="rawMaterialsDetailSerch.jsp"></jsp:include>
			<!-- 自定义属性弹出编辑框  start-->
			  <!---弹出框-普通---->
						...
						<div style="line-height: 30px;">
							<div style="width: 100%;padding-left: 25%;">
								<label><span
									...
									<input type="text"
									name="rawMaterialsPropertyName" class="sp-input"
									ng-model="customerRawMaterialsProperty.rawMaterialsPropertyName"
							...
							<div style="width: 100%;padding-left: 25%;">
								<label><span
									...
									<input type="text"
									name="rawMaterialsProperty" class="sp-input"
									ng-model="customerRawMaterialsProperty.rawMaterialsPropertyValue"
									placeholder="属性值" ng-maxlength="128" style="font-weight: normal;"/></label><br>
							</div>
						</div>
						<div ng-show="showcustomerRawMaterialsProperty" style="width: 100%;padding-left: 25%;color:red">属性名和属性值不能为空！</div>
						<div style="text-align: center;">
							<button type="button" class="sp-btn sp-btn-gray-md"
								ng-click="onAddCustomerPropertyItemClick(customerRawMaterialsProperty)">完成</button>
						</div>
				</div>
			  </div>
			<!-- 自定义属性弹出编辑框  end-->
			...
			<form name="unitValueFrom" id="unitValueFrom"
			  ...
			  <div id='addRawMaterialsPackUnit'class='sp-popup sp-popup-normal'>
			    <div class='sp-pop-header'>
			    <div id="pop-logo" class="sp-pop-logo"><span>包装单位</span></div>
				<div class="sp-pop-exit"><a href="javascript:exitPop('addRawMaterialsPackUnit');"><img src='<%=path%>/img/cross.png'></a></div>
				</div>
				<div class='sp-pop-content-normal' style="padding-top: 15%;overflow: hidden;">
			...
			<!-- 自定义属性弹出编辑框  end-->
			<jsp:include page="rawMaterialsDetailAdd.jsp"></jsp:include>
			<jsp:include page="rawMaterialsDetailEditAndShow.jsp"></jsp:include>
	</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/rawMaterials/rawMaterials.js"></script>
