...
<link rel="stylesheet" href="<%=path%>/css/datetimepicker.css" type="text/css">
<link rel="stylesheet" href="<%=path%>/css/pms/pms.css">
</head>
<body ng-app="commentApp" ng-controller="commentCtrl" ng-cloak style="overflow: hidden;" class="ng-cloak">
					...
					<div class="sp-content-bg" style="background-color: white; width: 101%;">
						...
						<div class="sp-panel panel panel-default">
							...
							<div class="sp-panel-body panel-body"
								...
								<span style="padding-left: 15px;"> 商品评价  — {{categoryName}} </span>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/comment/comment.js"></script>
