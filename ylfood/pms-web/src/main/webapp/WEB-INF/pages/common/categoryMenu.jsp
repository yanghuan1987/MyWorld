...
<div class="sp-menu-left" style="overflow-y: auto;overflow-x: hidden;border-left: 5px solid #ebebeb;width: 20%;" ng-cloak>
	...
	<div class="sp-menu" style="overflow-x: hidden;width: 40%;background-color: #4b4b4b;float: left;">
		<ul class="sp-nav-menu autobreak" ng-repeat="cat1 in categoryList" style="background-color: #4b4b4b;">
				  <li class="sp-li-line" ng-click="updateOne(cat1)" id="{{cat1.categoryName}}" ng-if ="category.categoryName==cat1.categoryName" Style="cursor:pointer;height:100%;background-color:{{colorone}};"><a style="color: #fff;"><img src='<%=path%>/img/pms/whiteDown.png'>&nbsp;{{cat1.categoryName}}</a></li>
				  <li class="sp-li-line" ng-click="updateOne(cat1)" id="{{cat1.categoryName}}" ng-if ="category.categoryName!=cat1.categoryName" Style="cursor:pointer;height:100%;cursor:pointer"><a style="color: #fff;"><img src='<%=path%>/img/pms/whiteDown.png'>&nbsp;{{cat1.categoryName}}</a></li>
		</ul>
		<button type="button" style="width: 100%;color: #fff;background: linear-gradient(#4b4b4b,#4b4b4b);" ng-click="addOne()" class="btn-block sp-menu-btn">新增一级分类</button>
	</div>
